...
const ProfilePage = () => {
    ...
    useEffect(() => {
        const fetchUserProfile = async () => {
            try {
                ...
                const res = await axios.get(`${process.env.REACT_APP_API_URL || 'http://localhost:2151'}/api/auth/me`, {
                    headers: {
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            ...
            await axios.patch(`${process.env.REACT_APP_API_URL || 'http://localhost:2151'}/api/auth/me`, updatedData, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL || 'http://localhost:2151'}/api/auth/setPhoto`, formData);
